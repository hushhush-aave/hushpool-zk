...
exports.getDataProvider = (network="kovan") => {
    let addrs = {
...
exports.getLendingPool = (network="kovan") => {
    let addrs = {
...
exports.getAavePool = (network="kovan") => {
    let addrs = {
        "kovan": "0xCd10478DBF5f4aC1D41401A7820d33038C228A5f"
    };
    return addrs[network];
}

exports.getMiMC = (network="kovan") => {
    let mimcAddresses = {
...
exports.getERC20Token = (network="kovan") => {
    let tokenAddresses = {
...
exports.getERCZKPool = (network="kovan") => {
    let zkpoolAddresses = {
